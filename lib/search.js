...
(function(){
  var Charm, vw, ttys, migemo, e, bytesToString, DOWN, UP, BACKSPACE, CTRLC, CTRLD, CTRLN, CTRLP, ENTER, search, searchUsingDefault, searchCore, cleanupScreen, drawScreen, getHits, queryHits, SearchyMatch, readStdinAsLinesThen, noEmpty, searchFromStdin, out$ = typeof exports != 'undefined' && exports || this;
  Charm = require('charm');
